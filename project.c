...
int main()
{
	...
	const char* pptFilePath = "C:\\Users\\Dell\\Desktop\\project pf ka.ppsx"; 
	...
	if(op=='Y'||op=='y')
	{
        ...
        "Q7: Kate, Joanna and Natalie are three sisters. If the following statements are all true which of them is the youngest.    - Kate is the oldest.\n    - Natalie is not the oldest.\n    - Joanna is not the youngest.",
